...
const initialParts: Part[] = [
  ...
  { x: 2, y: 0, color: colors[0] },
  { x: 1, y: 1, color: colors[0] },
  { x: 1, y: 2, color: colors[0] },
  { x: 1, y: 3, color: colors[0] },
  { x: 1, y: 4, color: colors[0] },
  // A
  { x: 4, y: 1, color: colors[1] },
  { x: 4, y: 2, color: colors[1] },
  { x: 4, y: 3, color: colors[1] },
  { x: 4, y: 4, color: colors[1] },
  { x: 5, y: 0, color: colors[1] },
  { x: 5, y: 2, color: colors[1] },
  { x: 6, y: 0, color: colors[1] },
  { x: 6, y: 1, color: colors[1] },
  { x: 6, y: 2, color: colors[1] },
  { x: 6, y: 3, color: colors[1] },
  { x: 6, y: 4, color: colors[1] },
  // I
  { x: 8, y: 0, color: colors[2] },
  { x: 8, y: 1, color: colors[2] },
  { x: 8, y: 2, color: colors[2] },
  { x: 8, y: 3, color: colors[2] },
  { x: 8, y: 4, color: colors[2] },
  // C
  { x: 11, y: 1, color: colors[3] },
  { x: 11, y: 2, color: colors[3] },
  { x: 11, y: 3, color: colors[3] },
  { x: 12, y: 0, color: colors[3] },
  { x: 12, y: 4, color: colors[3] },
  { x: 13, y: 0, color: colors[3] },
  { x: 13, y: 4, color: colors[3] },
  // H
  { x: 15, y: 0, color: colors[4] },
  { x: 15, y: 1, color: colors[4] },
  { x: 15, y: 2, color: colors[4] },
  { x: 15, y: 3, color: colors[4] },
  { x: 15, y: 4, color: colors[4] },
  { x: 16, y: 2, color: colors[4] },
  { x: 17, y: 0, color: colors[4] },
  { x: 17, y: 1, color: colors[4] },
  { x: 17, y: 2, color: colors[4] },
  { x: 17, y: 3, color: colors[4] },
  { x: 17, y: 4, color: colors[4] },
  // I
  { x: 19, y: 0, color: colors[5] },
  { x: 19, y: 1, color: colors[5] },
  { x: 19, y: 2, color: colors[5] },
  { x: 19, y: 3, color: colors[5] },
  { x: 19, y: 4, color: colors[5] },
];
