...
import FullScreenButton from '@/components2/media/FullScreenButton.vue';
import PlaybackRateButton from '@/components2/media/PlaybackRateButton.vue';
import PlayPauseButton from '@/components2/media/PlayPauseButton.vue';
import VideoProgressBar from '@/components2/media/ProgressBar.vue';
import QuickSeekButton from '@/components2/media/QuickSeekButton.vue';
import TimeShow from '@/components2/media/TimeShow.vue';
