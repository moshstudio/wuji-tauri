...
<template>
  ...
  >
    <div class="relative h-full flex flex-col">
      <div
        class="shrink-0 h-[60px] p-2 border-b border-gray-200 flex items-center justify-between z-10 text-[--van-text-color] bg-[--van-background]"
      >
      ...
      >
        <van-tab title="示例">
          <div
            class="flex-1 overflow-auto p-4 markdown-body github-markdown-dark"
            v-html="htmlContent"
          ></div>
        </van-tab>
        <van-tab title="通用函数">
