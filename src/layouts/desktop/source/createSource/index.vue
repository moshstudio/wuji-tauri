...
import IEditor from '@/components2/codeEditor/IEditor.vue';
import Guide from '@/components2/codeEditor/Guide.vue';
import {
  PHOTO_CONSTRUCTOR,
  PHOTO_DETAIL,
  PHOTO_LIST,
  ...
  SONG_PLAY_URL,
  SONG_LYRIC,
} from '@/components2/codeEditor/templates';
import { guideExamplesMD } from '@/components2/codeEditor/guides';
...
import ConfirmCreateSubscribeSource from '@/components2/dialog/ConfirmCreateSubscribeSource.vue';
...
<template>
  <div class="relative flex h-full w-full flex-col overflow-hidden">
    ...
    >
      <div
        class="page-select flex h-full w-[120px] flex-col gap-2 overflow-y-auto"
      >
      ...
      <div class="flex h-full w-full flex-1 flex-col">
        <div class="flex items-center gap-1.5 rounded bg-gray-900 px-2 py-1.5">
          <!-- 按钮组 -->
          <button
            class="rounded bg-gray-700 px-2 py-1 text-xs font-medium text-gray-200 transition-colors hover:bg-gray-600 focus:bg-gray-600 focus:outline-none focus:ring-1 focus:ring-blue-500"
          ...
          <button
            class="rounded bg-blue-600 px-2 py-1 text-xs font-medium text-white transition-colors hover:bg-blue-500 focus:bg-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-400"
            @click="handleRun"
      ...
      <div
        v-show="showPreview"
        class="flex flex-1 flex-col overflow-auto text-[--van-text-color]"
      >
