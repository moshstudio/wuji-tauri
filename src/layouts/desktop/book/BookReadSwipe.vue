...
<template>
  ...
  >
    ...
    >
      <div
        v-show="showMenu"
        class="top_menu absolute top-0 z-[5] flex w-full flex-col gap-2 bg-[var(--van-background)] p-2 pr-[58px] shadow transition"
      >
    ...
    >
      <div
        v-show="showMenu"
        class="bottom up-shadow absolute bottom-0 left-0 z-[6] flex w-full flex-col bg-[var(--van-background)] p-2 pr-[58px] text-[var(--van-text-color)] transition"
      >
