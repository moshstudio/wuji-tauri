...
<template>
  ...
  >
    <div
      v-if="isShowing"
      class="z-2 up-shadow video-list flex h-full w-[42%] flex-shrink-0 cursor-auto flex-col overflow-hidden rounded-t-lg bg-[var(--van-background-2)] text-[var(--van-text-color)]"
    >
