...
<template>
  ...
  >
    <!-- 顶部菜单 -->
    <div
      class="top_menu fixed left-0 top-0 z-[5] flex w-full flex-col gap-2 bg-[var(--van-background)] p-2 shadow transition"
    >
    ...
    <!-- 底部菜单 -->
    <div
      class="bottom up-shadow fixed bottom-0 left-0 z-[6] flex w-full flex-col bg-[var(--van-background)] p-2 pb-[50px] text-[var(--van-text-color)] transition"
    >
