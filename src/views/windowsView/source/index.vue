...
<template>
  ...
  >
    <div class="relative h-full flex flex-col">
      <van-nav-bar :title="'管理订阅源'" left-arrow @click-left="save" />
      <van-collapse
        v-remember-scroll
        v-model="activeNames"
        class="overflow-y-auto touch-auto"
        @touchmove.stop
      >
              ...
              >
                <template #value>
                  <div class="flex items-center">
                    <van-popover v-if="item.detail.id === store.localSourceId">
                      <van-button
                        size="small"
                        type="danger"
                        @click="
                          () =>
                            sourceStore.removeItemFromSubscribeSource(
                              cell.id,
                              item.detail.id,
                            )
                        "
