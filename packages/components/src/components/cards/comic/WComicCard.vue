...
<template>
  <div
    class="active-bg-scale flex min-w-[280px] max-w-[280px] gap-2 rounded-lg p-2"
    @click="() => click(comic)"
  >
    ...
    <div
      class="flex flex-grow flex-col justify-around overflow-hidden text-sm text-[--van-text-color]"
    >
      <p
