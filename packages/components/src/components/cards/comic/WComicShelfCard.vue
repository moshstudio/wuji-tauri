...
<template>
  ...
  >
    ...
    >
      ...
      <p class="line-clamp-1 flex gap-2 text-xs">
        <span v-if="comic.comic.author" class="truncate">
          {{ comic.comic.author }}
        </span>
    ...
    <div class="van-haptics-feedback mt-1 flex flex-col justify-start">
      <van-icon
        name="ellipsis"
